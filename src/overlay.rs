    ...
    let store = if ctx == HelpCtx::Sqlite {
        HelpSection {
            ...
            keys: &[
                ...
                ("S", "Schema view"),
                ("P", "Edit pragmas"),
                ("H / U", "Hide column / show all"),
                ("f", "Freeze columns to cursor"),
                ...
                ("z / Z", "Clear sorting / filter"),
                ("L", "Unlock view editing"),
                ("Ctrl-y", "Copy column name"),
                ("Ctrl-n", "Set the cell to NULL"),
                ("Ctrl-h", "Copy the cell as hex"),
                ("Ctrl-e", "Open the cell externally"),
                ("Ctrl-r / F5", "Re-read the database"),
                ("Ctrl-p", "Print through lpr"),
                ("D", "Database info"),
                ("A", "Column statistics"),
                ("Y", "Copy row as INSERT"),
                ("F", "Follow foreign key"),
                ("s", "Sort column"),
                ("< / >", "Sort prev/next col"),
            ],
        }
